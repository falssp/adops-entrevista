...
d.tiers[1].questions.push(
  {
    q: { pt: 'O que são estudos de incrementalidade e como eles diferem de atribuição tradicional?', en: 'What are incrementality studies and how do they differ from traditional attribution?', es: '¿Qué son los estudios de incrementalidad y cómo difieren de la atribución tradicional?' },
    a: {
      pt: `<strong>Incrementalidade vs Atribuição Tradicional:</strong><br><br>
<strong>Problema da atribuição tradicional:</strong><br>
Modelos como last-click ou data-driven respondem "quem clicou antes da conversão?" — mas não dizem se a conversão teria acontecido mesmo sem o anúncio. Superestimam o impacto de campanhas de retargeting e brand que alcançam usuários que já iam converter.<br><br>
<strong>O que é Incrementalidade:</strong><br>
Mede o <strong>impacto causal real</strong> da publicidade — quantas conversões ADICIONAIS aconteceram por causa do anúncio que NÃO teriam acontecido sem ele.<br><br>
<strong>Como funciona um estudo de incrementalidade:</strong><br>
1. <strong>Grupo de teste (exposed)</strong> — vê os anúncios normalmente<br>
2. <strong>Grupo de controle (holdout)</strong> — NÃO vê os anúncios (recebe PSA ou nada)<br>
3. Comparar conversões dos dois grupos após o período<br>
4. <strong>Lift incremental</strong> = conversões (teste) - conversões (controle)<br><br>
<strong>Tipos de estudos:</strong><br>
• <strong>Geo experiments</strong> — regiões geográficas como teste/controle (ex: DMA nos EUA)<br>
• <strong>User-level holdout</strong> — % de usuários aleatoriamente excluídos das campanhas<br>
• <strong>Ghost ads</strong> — usuários de controle "veriam" o ad na mesma posição, mas é invisível<br>
• <strong>Platform lift studies</strong> — Meta Conversion Lift, Google Brand Lift<br><br>
<strong>Quando usar:</strong><br>
• Avaliar valor REAL de campanhas de retargeting<br>
• Medir impacto de campanhas de awareness em conversões downstream<br>
• Otimizar alocação de budget entre canais<br>
• Quando atribuição baseada em cookies está comprometida (iOS 14+)`,
      en: `<strong>Incrementality vs Traditional Attribution:</strong><br><br>
<strong>Problem with traditional attribution:</strong> Models like last-click or data-driven answer "who clicked before conversion?" but don't tell if the conversion would have happened without the ad. They overestimate retargeting and brand campaign impact.<br><br>
<strong>What incrementality measures:</strong> The CAUSAL impact — how many ADDITIONAL conversions happened because of the ad that would NOT have happened without it.<br><br>
<strong>How it works:</strong><br>
1. Test group (exposed) — sees ads normally<br>
2. Control group (holdout) — does NOT see ads<br>
3. Compare conversions after the period<br>
4. Incremental lift = conversions (test) - conversions (control)<br><br>
<strong>Study types:</strong> Geo experiments, User-level holdout, Ghost ads, Platform lift studies (Meta Conversion Lift, Google Brand Lift)<br><br>
<strong>When to use:</strong> Evaluate real retargeting value, measure awareness impact on downstream conversions, optimize budget allocation across channels`,
      es: `<strong>Incrementalidad vs Atribución Tradicional:</strong><br><br>
<strong>Problema con la atribución tradicional:</strong> Modelos como last-click responden "¿quién hizo clic antes de la conversión?" pero no dicen si la conversión habría ocurrido sin el anuncio.<br><br>
<strong>Qué mide la incrementalidad:</strong> El impacto CAUSAL real — cuántas conversiones ADICIONALES ocurrieron gracias al anuncio que NO habrían ocurrido sin él.<br><br>
<strong>Cómo funciona:</strong><br>
1. Grupo de prueba (expuesto) → ve los anuncios normalmente<br>
2. Grupo de control (holdout) → NO ve los anuncios<br>
3. Comparar conversiones de ambos grupos<br>
4. Lift incremental = conversiones (prueba) - conversiones (control)<br><br>
<strong>Tipos de estudios:</strong> Geo experiments, User-level holdout, Ghost ads, Platform lift studies`,
    },
    tags: ['atribuição', 'incrementalidade', 'holdout', 'geo-experiment', 'causalidade', 'lift']
  },
  {
    q: { pt: 'O que é Marketing Mix Modeling (MMM) e quando usar vs atribuição digital?', en: 'What is Marketing Mix Modeling (MMM) and when to use it vs digital attribution?', es: '¿Qué es Marketing Mix Modeling (MMM) y cuándo usarlo vs atribución digital?' },
    a: {
      pt: `<strong>Marketing Mix Modeling (MMM):</strong><br><br>
<strong>O que é:</strong> Técnica estatística (regressão) que analisa dados históricos de todos os canais de marketing (TV, digital, OOH, rádio, promo, sazonalidade, preço) para estimar a contribuição de cada canal nas vendas/receita.<br><br>
<strong>Como funciona:</strong><br>
• Coleta dados históricos de pelo menos 2-3 anos de: investimento por canal, vendas/receita, dados macroeconômicos, sazonalidade<br>
• Modelo de regressão decompõe a receita entre variáveis: "quanto das minhas vendas é explicado por TV vs Search vs Display vs preço vs sazonalidade?"<br>
• Gera curvas de saturação e elasticidade por canal<br>
• Permite simulação de "what-if": "se eu mover $X de TV para Search, como impacta receita?"<br><br>
<strong>Vantagens do MMM:</strong><br>
• Mede todos os canais, online E offline (TV, OOH, rádio)<br>
• Não depende de cookies ou tracking user-level<br>
• Captura efeitos de longo prazo (brand building)<br>
• Resistente a mudanças de privacidade<br><br>
<strong>Limitações do MMM:</strong><br>
• Requer muitos dados históricos (min. 2 anos)<br>
• Granularidade limitada (nível de canal, não keyword/criativo)<br>
• Demora semanas/meses para rodar e interpretar<br>
• Custo alto de desenvolvimento e especialista estatístico<br><br>
<strong>MMM vs Atribuição Digital — quando usar cada:</strong><br>
| Cenário | MMM | Atribuição Digital |
|---------|-----|-------------------|
| Canais offline | ✅ | ❌ |
| Decisão de budget total | ✅ | ❌ |
| Otimização de keyword/ad | ❌ | ✅ |
| Velocidade de feedback | Lento | Rápido |
| Privacidade | Alta | Comprometida |<br><br>
<strong>Melhor prática:</strong> MMM + Incrementalidade + Atribuição como camadas complementares`,
      en: `<strong>Marketing Mix Modeling (MMM):</strong><br><br>
<strong>What it is:</strong> Statistical technique (regression) analyzing historical data from all marketing channels (TV, digital, OOH, radio, promo, seasonality, price) to estimate each channel's contribution to sales/revenue.<br><br>
<strong>How it works:</strong> Collect 2-3+ years of historical data (spend by channel, revenue, macroeconomic data, seasonality) → regression model decomposes revenue among variables → generates saturation/elasticity curves → enables "what-if" simulations<br><br>
<strong>MMM advantages:</strong> Measures all channels online AND offline; no cookies or user-level tracking; captures long-term brand effects; privacy-resistant<br><br>
<strong>MMM limitations:</strong> Requires lots of historical data (min. 2 years); limited granularity (channel-level, not keyword/creative); takes weeks/months; high development cost<br><br>
<strong>MMM vs Digital Attribution — when to use each:</strong><br>
• Offline channels, total budget decision → MMM<br>
• Keyword/ad optimization, fast feedback → Digital Attribution<br>
• Best practice: MMM + Incrementality + Attribution as complementary layers`,
      es: `<strong>Marketing Mix Modeling (MMM):</strong><br><br>
<strong>Qué es:</strong> Técnica estadística (regresión) que analiza datos históricos de todos los canales de marketing para estimar la contribución de cada canal en las ventas/ingresos.<br><br>
<strong>Ventajas del MMM:</strong><br>
• Mide todos los canales, online Y offline<br>
• No depende de cookies ni tracking a nivel de usuario<br>
• Captura efectos a largo plazo (brand building)<br>
• Resistente a cambios de privacidad<br><br>
<strong>Limitaciones:</strong> Requiere muchos datos históricos (mín. 2 años), granularidad limitada, demora semanas/meses<br><br>
<strong>MMM vs Atribución Digital:</strong><br>
• Canales offline, decisión de presupuesto total → MMM<br>
• Optimización de keywords/anuncios, feedback rápido → Atribución Digital`,
    },
    tags: ['atribuição', 'MMM', 'marketing-mix-model', 'offline', 'regressão', 'budget']
  }
);
d.tiers[2].questions.push(
  {
    q: { pt: 'Como você explicaria para um cliente a diferença entre correlação e causalidade em mensuração de campanhas?', en: 'How would you explain to a client the difference between correlation and causality in campaign measurement?', es: '¿Cómo explicarías a un cliente la diferencia entre correlación y causalidad en la medición de campañas?' },
    a: {
      pt: `<strong>Correlação vs Causalidade em mensuração de campanhas:</strong><br><br>
<strong>O problema na prática:</strong><br>
Modelos de atribuição como last-click medem correlação ("quem clicou antes da conversão?"), não causalidade ("o clique CAUSOU a conversão?"). Isso cria vieses sistemáticos.<br><br>
<strong>Exemplos concretos de confusão correlação/causalidade:</strong><br><br>
<strong>Exemplo 1 — Retargeting superestimado:</strong><br>
• Usuário pesquisou "Nike tênis comprar" → visitou nike.com → adicionou ao carrinho → saiu<br>
• Retargeting exibiu 3 banners → usuário voltou e comprou<br>
• Last-click atribui 100% ao retargeting<br>
• Mas: esse usuário provavelmente ia comprar de qualquer jeito (alta intenção já demonstrada)<br>
• Incrementalidade: mostrar que o grupo sem retargeting converte apenas 2% menos = retargeting tem impacto real pequeno<br><br>
<strong>Exemplo 2 — Brand search não é causa:</strong><br>
• TV campaign no ar → spike em buscas pela marca → conversões por "busca orgânica de marca"<br>
• Last-click atribui as conversões à busca orgânica<br>
• Real: TV causou o interesse, busca foi só o último passo<br><br>
<strong>Como explicar para o cliente (analogia):</strong><br>
"Imagine que você tem um guarda-chuva e toda vez que o abre, chove. Correlação: abrir guarda-chuva 'causa' chuva? Não — ambos foram causados pela nuvem carregada. Em campanhas: o banner de retargeting não 'causou' a compra, a intenção de compra já existia — e o banner apareceu por isso."<br><br>
<strong>Solução recomendada:</strong><br>
• Usar incrementalidade para medir impacto causal real<br>
• Complementar atribuição com estudos de holdout<br>
• Não otimizar só por last-click — pode estar otimizando para canais que "pegam carona" em intenção já existente`,
      en: `<strong>Correlation vs Causality in campaign measurement:</strong><br><br>
<strong>The core problem:</strong> Attribution models like last-click measure correlation ("who clicked before conversion?"), not causality ("did the click CAUSE the conversion?"). This creates systematic biases.<br><br>
<strong>Concrete examples:</strong><br>
1. <strong>Retargeting overestimated</strong> — user searched "Nike shoes buy" → added to cart → left → saw 3 retargeting banners → bought. Last-click attributes 100% to retargeting. But: user was likely buying anyway. Incrementality shows holdout group converts only 2% less = retargeting's real impact is small.<br>
2. <strong>Brand search isn't the cause</strong> — TV campaign runs → spike in brand searches → conversions attributed to "organic brand search." Reality: TV caused interest, search was just the last step.<br><br>
<strong>How to explain to client (analogy):</strong> "Every time you open an umbrella, it rains. Did the umbrella cause the rain? No — both were caused by storm clouds. In campaigns: the retargeting banner didn't 'cause' the purchase; the intent already existed."<br><br>
<strong>Recommended solution:</strong> Use incrementality for real causal impact; complement attribution with holdout studies; don't optimize solely by last-click`,
      es: `<strong>Correlación vs Causalidad en medición de campañas:</strong><br><br>
<strong>El problema central:</strong> Los modelos de atribución como last-click miden correlación ("¿quién hizo clic antes de la conversión?"), no causalidad ("¿el clic CAUSÓ la conversión?").<br><br>
<strong>Ejemplo concreto — Retargeting sobreestimado:</strong><br>
Usuario buscó "Nike zapatillas comprar" → añadió al carrito → salió → vio 3 banners de retargeting → volvió y compró. Last-click atribuye el 100% al retargeting. Pero: este usuario probablemente iba a comprar de todas formas (ya mostraba alta intención).<br><br>
<strong>Cómo explicarlo al cliente (analogía):</strong><br>
"Cada vez que abres un paraguas, llueve. ¿Abrir el paraguas 'causa' la lluvia? No — ambos fueron causados por las nubes cargadas. En campañas: el banner de retargeting no 'causó' la compra; la intención de compra ya existía."<br><br>
<strong>Solución recomendada:</strong> Usar incrementalidad para medir impacto causal real; complementar atribución con estudios de holdout`,
    },
    tags: ['atribuição', 'causalidade', 'correlação', 'incrementalidade', 'retargeting', 'last-click']
  }
);
})();
