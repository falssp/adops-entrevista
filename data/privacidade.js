...
d.tiers[0].questions.push(
  {
    q: { pt: 'O que é o Privacy Sandbox do Google e quais são suas principais APIs?', en: 'What is Google\'s Privacy Sandbox and what are its main APIs?', es: '¿Qué es el Privacy Sandbox de Google y cuáles son sus principales APIs?' },
    a: {
      pt: `<strong>Privacy Sandbox:</strong><br><br>
<strong>O que é:</strong> Conjunto de iniciativas e APIs desenvolvidas pelo Google para substituir cookies de terceiros no Chrome, mantendo publicidade eficiente sem expor dados de usuários individuais a terceiros.<br><br>
<strong>Principais APIs:</strong><br><br>
<strong>1. Topics API (substitui FLoC):</strong><br>
• Browser do usuário classifica os sites visitados em ~350 tópicos de interesse (ex: "Sports", "Travel")<br>
• Ad techs podem consultar os top 3 tópicos do usuário na última semana<br>
• Usuário mantém controle: pode ver e excluir tópicos<br>
• Sem envio de histórico de navegação para servidores externos<br><br>
<strong>2. Protected Audience API (antigo FLEDGE):</strong><br>
• Substitui o remarketing baseado em cookies de terceiros<br>
• Audiências são armazenadas no próprio browser do usuário, não em servidores externos<br>
• Leilão acontece localmente no browser<br>
• Ad network propõe lances sem ver o histórico completo do usuário<br><br>
<strong>3. Attribution Reporting API:</strong><br>
• Substitui o pixel de conversão third-party<br>
• Atribuição acontece no browser, não em servidores de tracking<br>
• Dados agregados com ruído (differential privacy) para proteger privacidade<br><br>
<strong>4. Related Website Sets (antigo First-Party Sets):</strong><br>
• Permite que domínios relacionados de uma mesma empresa compartilhem cookies<br>
• Ex: marca.com e loja.marca.com podem compartilhar dados com consentimento<br><br>
<strong>Status atual:</strong><br>
• Google adiou o fim dos cookies de terceiros no Chrome várias vezes<br>
• Posição atual (2024-2025): manter cookies mas oferecer opção de privacidade ao usuário<br>
• APIs do Privacy Sandbox disponíveis mas adoção ainda inicial`,
      en: `<strong>Privacy Sandbox:</strong><br><br>
<strong>What it is:</strong> Set of initiatives and APIs developed by Google to replace third-party cookies in Chrome while maintaining effective advertising without exposing individual user data to third parties.<br><br>
<strong>Main APIs:</strong><br>
1. <strong>Topics API</strong> — browser classifies visited sites into ~350 interest topics; ad techs can query user's top 3 topics from the last week; no browsing history sent to external servers<br>
2. <strong>Protected Audience API</strong> (formerly FLEDGE) — remarketing without third-party cookies; audiences stored in user's browser; auction happens locally<br>
3. <strong>Attribution Reporting API</strong> — replaces third-party conversion pixel; attribution happens in browser; aggregated data with noise (differential privacy)<br>
4. <strong>Related Website Sets</strong> — allows related domains of same company to share cookies<br><br>
<strong>Current status:</strong> Google delayed third-party cookie deprecation multiple times; current position: keep cookies but offer user privacy choice; Privacy Sandbox APIs available but adoption still early`,
      es: `<strong>Privacy Sandbox:</strong><br><br>
<strong>Qué es:</strong> Conjunto de iniciativas y APIs desarrolladas por Google para reemplazar las cookies de terceros en Chrome, manteniendo publicidad eficiente sin exponer datos de usuarios individuales.<br><br>
<strong>Principales APIs:</strong><br>
1. <strong>Topics API</strong> — el navegador clasifica los sitios visitados en ~350 temas de interés; sin envío de historial de navegación a servidores externos<br>
2. <strong>Protected Audience API</strong> — remarketing sin cookies de terceros; las audiencias se almacenan en el navegador del usuario<br>
3. <strong>Attribution Reporting API</strong> — reemplaza el pixel de conversión de terceros; atribución en el navegador con privacidad diferencial<br>
4. <strong>Related Website Sets</strong> — permite que dominios relacionados de la misma empresa compartan cookies`,
    },
    tags: ['privacidade', 'Privacy Sandbox', 'Topics API', 'FLEDGE', 'Protected Audience', 'cookies', 'Google']
  }
);
d.tiers[1].questions.push(
  {
    q: { pt: 'O que são soluções de identidade cookieless e como elas funcionam?', en: 'What are cookieless identity solutions and how do they work?', es: '¿Qué son las soluciones de identidad sin cookies y cómo funcionan?' },
    a: {
      pt: `<strong>Soluções de identidade cookieless:</strong><br><br>
<strong>Por que são necessárias:</strong><br>
• Cookies de terceiros estão sendo eliminados (Safari/Firefox já bloqueiam; Chrome em transição)<br>
• Sem cookies, targeting, frequência e atribuição são prejudicados<br>
• Soluções de identidade alternativas preenchem esse gap<br><br>
<strong>Principais soluções:</strong><br><br>
<strong>1. Unified ID 2.0 (UID2) — The Trade Desk:</strong><br>
• Usuário fornece email → hash SHA-256 → token padronizado compartilhado entre publishers e ad techs<br>
• Requer consentimento explícito do usuário<br>
• Open-source, gerenciado pela Prebid.org<br>
• Amplamente adotado em programático<br><br>
<strong>2. Google Privacy Sandbox (Topics + Protected Audience):</strong><br>
• Abordagem baseada no browser, sem identificador persistente<br>
• Sem necessidade de email do usuário<br><br>
<strong>3. ID5:</strong><br>
• ID compartilhado entre publishers e ad techs<br>
• Combina first-party data de publishers com sinal de identidade consolidado<br><br>
<strong>4. LiveRamp RampID (Authenticated Traffic Solution):</strong><br>
• Resolve identidade cross-device baseada em dados autenticados (login)<br>
• Forte em CTV e ambientes sem cookie<br><br>
<strong>5. Fingerprinting (probabilístico):</strong><br>
• Combina características do browser/dispositivo (resolução, timezone, user agent, plugins)<br>
• Não requer identificador declarado<br>
• Mais impreciso e controverso (Apple bloqueia ativamente)<br><br>
<strong>First-party data como base:</strong><br>
• A solução mais sustentável: coletar emails e dados com consentimento explícito<br>
• Customer Match (Google), Custom Audiences (Meta) usam first-party data com hashing`,
      en: `<strong>Cookieless identity solutions:</strong><br><br>
<strong>Why they're needed:</strong> Third-party cookies are being eliminated; without them, targeting, frequency, and attribution suffer<br><br>
<strong>Main solutions:</strong><br>
1. <strong>Unified ID 2.0 (UID2)</strong> — The Trade Desk: user provides email → SHA-256 hash → standardized token shared between publishers and ad techs; requires explicit consent; open-source via Prebid.org<br>
2. <strong>Google Privacy Sandbox</strong> — browser-based approach without persistent identifier<br>
3. <strong>ID5</strong> — shared ID between publishers and ad techs; combines publisher first-party data<br>
4. <strong>LiveRamp RampID</strong> — cross-device identity from authenticated data (login); strong in CTV<br>
5. <strong>Fingerprinting (probabilistic)</strong> — browser/device characteristics; less precise, controversial<br><br>
<strong>First-party data as foundation:</strong> Most sustainable solution: collect emails with explicit consent; Customer Match, Custom Audiences use hashed first-party data`,
      es: `<strong>Soluciones de identidad sin cookies:</strong><br><br>
<strong>Por qué son necesarias:</strong> Las cookies de terceros están siendo eliminadas; sin ellas, el targeting, la frecuencia y la atribución se ven perjudicados<br><br>
<strong>Principales soluciones:</strong><br>
1. <strong>Unified ID 2.0 (UID2)</strong> — The Trade Desk: email → hash SHA-256 → token estandarizado compartido; requiere consentimiento explícito<br>
2. <strong>Google Privacy Sandbox</strong> — enfoque basado en el navegador sin identificador persistente<br>
3. <strong>ID5</strong> — ID compartido entre publishers y ad techs<br>
4. <strong>LiveRamp RampID</strong> — identidad cross-device basada en datos autenticados<br>
5. <strong>Fingerprinting (probabilístico)</strong> — características del navegador/dispositivo; menos preciso y controvertido`,
    },
    tags: ['privacidade', 'cookieless', 'UID2', 'RampID', 'ID5', 'fingerprinting', 'first-party']
  }
);
})();
